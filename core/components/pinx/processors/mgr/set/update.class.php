 ...
 * PinX
 *
 * Copyright 2010 by Josh Tambunga <josh+pinx@joshsmind.com>
 *
 ...
 */
 class PinXSetUpdateProcessor extends modObjectUpdateProcessor {
    public $classKey = 'PinXSet';
    public $languageTopic = array('pinx:default');
    public $objectType = 'pinx.pinx';
}

return 'PinXSetUpdateProcessor';
